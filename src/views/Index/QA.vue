    ...
    return {
      ...
      qaLists: [
        ...
        },
        {
          id: 'b',
          q: '取消訂單與退款',
          a: `．出貨日前 10 天，將無法再取消訂單。
              ．取消之訂單如為信用卡付款，款項退刷需 7-14 個工作天入帳。
        ...
        },
        {
          ...
          a: `．【店內自取】
                  地址:台中市西屯區惠中二街26號
                  營業時間:周一~周五 ; 早上08:30~下午6:00，如有調整將另行通知。
              ．【宅配】
                  配送區域:台灣黑貓宅急便服務區域`,
        },
        {
        ...
        },
        {
          ...
          q: '當天無法取貨、收貨該怎麼辦？',
          a: `．【店內自取】
                  請來電04-22512636或fb臉書私訊告知，自取可先為您保存商品，但請於賞味期限內完成取貨。
              ．【宅配】
